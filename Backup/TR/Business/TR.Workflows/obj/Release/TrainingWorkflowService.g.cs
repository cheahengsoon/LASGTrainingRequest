...
namespace TR.Workflows {
    ...
    public partial class TrainingWorkflowService : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TrainingWorkflowService).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TrainingWorkflowService));
        ...
        private string FindResource() {
            string[] resources = typeof(TrainingWorkflowService).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TrainingWorkflowService.g.xaml") || resource.Equals("TrainingWorkflowService.g.xaml"))) {
                    return resource;
                }
            }
